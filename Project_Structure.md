...
| `src/web/dashboard.html` | **Dashboard** (Slice 5): self-contained single-page UI (vanilla JS + inline SVG sparklines) served at `GET /`; lists watches, price history, and the "Bucket reopened" badge. |
